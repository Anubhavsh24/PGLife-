            ...
            <div class="interested-container">
                ...
                ?>
                   <i class="is-interested-image fas fa-heart"
                        property_id="<?= $property['property_id'] ?>"></i>
                <?php
                } else {
                ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Book PG</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="move_in_date">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="occupants">
                    </div>
